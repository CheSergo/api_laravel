...
class DocumentsAntiCorruption extends Controller 
{
    ...
    public function index() {
        $builder = (object) $this->model::published()->orderBy('published_at', 'desc')
        ->thisSiteFront()
        ->where('is_anticorruption', 1)
    ...
    public function show(Request $request) {
        ...
        ->published()->where('is_anticorruption', true)
